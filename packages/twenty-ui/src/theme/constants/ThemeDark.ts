...
export const THEME_DARK: typeof THEME_LIGHT = {
  ...
  tag: {
    ...
    background: {
      gray: 'color(display-p3 0.114 0.114 0.114)',
      mauve: 'color(display-p3 0.167 0.161 0.175)',
      slate: 'color(display-p3 0.156 0.163 0.176)',
      sage: 'color(display-p3 0.155 0.164 0.159)',
      olive: 'color(display-p3 0.158 0.163 0.153)',
      sand: 'color(display-p3 0.164 0.163 0.156)',
      tomato: 'color(display-p3 0.282 0.099 0.077)',
      red: 'color(display-p3 0.287 0.079 0.113)',
      ruby: 'color(display-p3 0.279 0.092 0.147)',
      crimson: 'color(display-p3 0.277 0.087 0.182)',
      pink: 'color(display-p3 0.271 0.095 0.231)',
      plum: 'color(display-p3 0.25 0.121 0.271)',
      purple: 'color(display-p3 0.224 0.137 0.297)',
      violet: 'color(display-p3 0.191 0.148 0.345)',
      iris: 'color(display-p3 0.153 0.165 0.382)',
      cyan: 'color(display-p3 0.063 0.216 0.277)',
      turquoise: 'color(display-p3 0.087 0.227 0.214)',
      sky: 'color(display-p3 0.106 0.207 0.323)',
      blue: 'color(display-p3 0.129 0.18 0.369)',
      jade: 'color(display-p3 0.102 0.228 0.177)',
      green: 'color(display-p3 0.115 0.229 0.166)',
      grass: 'color(display-p3 0.142 0.225 0.15)',
      mint: 'color(display-p3 0.068 0.224 0.22)',
      lime: 'color(display-p3 0.13 0.16 0.099)',
      bronze: 'color(display-p3 0.185 0.166 0.156)',
      gold: 'color(display-p3 0.177 0.17 0.152)',
      brown: 'color(display-p3 0.191 0.161 0.138)',
