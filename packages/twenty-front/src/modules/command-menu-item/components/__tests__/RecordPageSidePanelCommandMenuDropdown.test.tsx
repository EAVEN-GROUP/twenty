...
const mockCloseLegacyDropdown = jest.fn();
...
jest.mock('@/ui/layout/dropdown/hooks/useCloseDropdown', () => ({
  useCloseDropdown: () => ({ closeDropdown: mockCloseLegacyDropdown }),
}));
...
describe('RecordPageSidePanelCommandMenuDropdown', () => {
  ...
  it('closes ordinary commands through feature state and excludes global commands', async () => {
    ...
    expect(mockCloseLegacyDropdown).not.toHaveBeenCalled();
  });
